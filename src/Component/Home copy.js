  ...
  return (
    <>
      <div className="row mb-5 bg_img">
            ...
            <Container>
              <Navbar.Brand href="#home">
                ...
                <img
                  ...
                  src="https://res.cloudinary.com/urbanclap/image/upload/q_auto:low,f_auto,fl_progressive:steep/images/growth/home-screen/1631097450980-d2de38.png"
                  alt=""
                />
              </Navbar.Brand>
              <Navbar.Toggle />
              <Navbar.Collapse className="justify-content-end">
                ...
                <Navbar.Text style={{ color: "white" }}>Help</Navbar.Text>
                <Navbar.Text style={{ color: "white" }}>
                  Login/Sign up{" "}
                </Navbar.Text>
              </Navbar.Collapse>
        ...
        <div className="row text-center p-5">
          <span>Home / Bengalore</span>
          <h1 className="colr ">Home services, on demand.</h1>
        </div>
        <div className="row  float-center m-auto">
          <Card
            style={{ width: "18rem", height: "40vh" }}
