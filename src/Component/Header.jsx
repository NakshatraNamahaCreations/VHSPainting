...
export default function Header() {
  return (
    <>
      ...
      <div className="row" style={{backgroundColor:"#f5f5f5",padding:"8px"}}>
           ...
           <div className="col-md-6 m-auto" style={{justifyContent:"center"}}>
              <div style={{textAlign:"end",color:"black",fontSize:"20px",fontWeight:"bold",paddingRight:"10px"}}>Vijay Home Services</div>
           </div>
      </div>
    </>
  );
